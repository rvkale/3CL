...
func k_crop_async ( dst unsafe.Pointer, Dx int, Dy int, Dz int, src unsafe.Pointer, Sx int, Sy int, Sz int, Offx int, Offy int, Offz int,  cfg *config, events []*cl.Event) *cl.Event {
...
//	args := crop_args.argptr[:]
	event := LaunchKernel("crop", cfg.Grid, cfg.Block, events)
