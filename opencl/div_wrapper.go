...
func k_pointwise_div_async ( dst unsafe.Pointer, a unsafe.Pointer, b unsafe.Pointer, N int,  cfg *config, events []*cl.Event) *cl.Event {
...
//	args := pointwise_div_args.argptr[:]
	event := LaunchKernel("pointwise_div", cfg.Grid, cfg.Block, events)
