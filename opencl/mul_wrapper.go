...
func k_mul_async ( dst unsafe.Pointer, a unsafe.Pointer, b unsafe.Pointer, N int,  cfg *config, events []*cl.Event) *cl.Event {
...
//	args := mul_args.argptr[:]
	event := LaunchKernel("mul", cfg.Grid, cfg.Block, events)
