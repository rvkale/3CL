...
func k_copyunpad_async ( dst unsafe.Pointer, Dx int, Dy int, Dz int, src unsafe.Pointer, Sx int, Sy int, Sz int,  cfg *config, events []*cl.Event) *cl.Event {
...
//	args := copyunpad_args.argptr[:]
	event := LaunchKernel("copyunpad", cfg.Grid, cfg.Block, events)
