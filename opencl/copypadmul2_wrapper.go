...
func k_copypadmul2_async ( dst unsafe.Pointer, Dx int, Dy int, Dz int, src unsafe.Pointer, Sx int, Sy int, Sz int, Ms_ unsafe.Pointer, Ms_mul float32, vol unsafe.Pointer,  cfg *config, events []*cl.Event) *cl.Event {
...
//	args := copypadmul2_args.argptr[:]
	event := LaunchKernel("copypadmul2", cfg.Grid, cfg.Block, events)
