...
func k_dotproduct_async ( dst unsafe.Pointer, prefactor float32, ax unsafe.Pointer, ay unsafe.Pointer, az unsafe.Pointer, bx unsafe.Pointer, by unsafe.Pointer, bz unsafe.Pointer, N int,  cfg *config, events []*cl.Event) *cl.Event {
...
//	args := dotproduct_args.argptr[:]
	event := LaunchKernel("dotproduct", cfg.Grid, cfg.Block, events)
