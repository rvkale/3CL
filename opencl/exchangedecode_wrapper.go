...
func k_exchangedecode_async ( dst unsafe.Pointer, aLUT2d unsafe.Pointer, regions unsafe.Pointer, wx float32, wy float32, wz float32, Nx int, Ny int, Nz int, PBC uint8,  cfg *config, events []*cl.Event) *cl.Event {
...
//	args := exchangedecode_args.argptr[:]
	event := LaunchKernel("exchangedecode", cfg.Grid, cfg.Block, events)
