...
func k_crossproduct_async ( dstx unsafe.Pointer, dsty unsafe.Pointer, dstz unsafe.Pointer, ax unsafe.Pointer, ay unsafe.Pointer, az unsafe.Pointer, bx unsafe.Pointer, by unsafe.Pointer, bz unsafe.Pointer, N int,  cfg *config, events []*cl.Event) *cl.Event {
...
//	args := crossproduct_args.argptr[:]
	event := LaunchKernel("crossproduct", cfg.Grid, cfg.Block, events)
