...
func newFFT3DR2C(Nx, Ny, Nz int) fft3DR2CPlan {
	...
	fmt.Printf("\n \n \n Printing the three values %d, %d and %d \n \n \n", Nx, Ny, Nz)
	...
	// }
	return fft3DR2CPlan{fftplan{effort}, [3]int{Nx, Ny, Nz}}
}
